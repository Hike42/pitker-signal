    ...
    <section className="bg-pitkerBlue min-h-screen pt-20 pb-20">
      <div className="max-w-7xl mx-auto px-4">
        <h1 className="text-white text-4xl md:text-5xl font-light mb-16">
          Our <span className="text-pitkerRed font-light">Leadership</span> Team
        </h1>
          ...
          {PARTNERS.map((partner) => (
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden rounded-sm">
                ...
                >
                  <div className="p-6">
                    {partner.biography.split('\n\n').map((paragraph, index) => (
                      <p key={index} className="text-white text-base leading-relaxed mb-4">
                        {paragraph}
                      </p>
                    ))}
                    <div className="flex space-x-4 mt-6">
                      <a href={`mailto:${partner.email}`} className="text-white hover:text-pitkerRed transition-colors">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/>
                        </svg>
                      </a>
                      <a href={partner.linkedin} target="_blank" rel="noopener noreferrer" className="text-white hover:text-pitkerRed transition-colors">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-6 space-y-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <p className="text-white text-sm">
                    Major: <span className="text-pitkerRed">{partner.major}</span>
                  </p>
                </div>
              </div>
            </div>
