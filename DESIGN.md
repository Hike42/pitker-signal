# PITKER — Direction Signal

Une marque de conseil affirmée : bleu PITKER, typographie Manrope monumentale, aplats blancs et étoile originale en signature. Les pages intérieures privilégient les titres forts, des grilles franches et une hiérarchie très directe.

## Invariants de marque

- PITKER s’écrit en majuscules.
- Bleu : `#003769`. Rouge : `#E63237`.
- Blanc et gris neutres en soutien.
- Logos officiels réutilisés depuis `public/navbarlogo.png` et `public/footerlogo.png`.
- Étoile officielle : `public/favicon.svg`. Ses deux teintes d’origine sont préservées.
- Les fichiers des logos ne sont ni redessinés ni recolorés.
