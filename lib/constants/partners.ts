...
export const PARTNERS: Partner[] = [
  {
    ...
    biography: {
      ...
      fr: "Depuis 27 ans, Jean-Marie accompagne les entreprises du secteur pharmaceutique, de la biotechnologie ou encore des dispositifs médicaux dans leurs recherches de dirigeants les plus stratégiques.\n\nAvant de co-fonder PITKER en 2020, Jean-Marie a passé seize ans chez Amrop, l'un de plus importants acteurs globaux de l'executive search.\n\nDe 2010 à 2020, Jean-Marie a notamment dirigé le bureau parisien d'Amrop. Pendant la même période, il était co-responsable pour l'Europe du pôle de compétences \"Life Sciences\" d'Amrop.\n\nJean-Marie est diplômé de l'Institut d'Etudes Politiques de Rennes et d'un troisième cycle en commerce international."
    }
  },
  {
    id: 2,
